...
You must return **Four items → In the github repo**
...
## 2️⃣ **Perform a GDPR check.**

1. Create a new page on Github (markdown) and add the table using the next file as a template: [GDPR Checklist](./GDPR_Checklist.md)
2. Go through the checklist

## 3️⃣ **Check the app's privacy policy**
...
## 4️⃣ **Check the app's terms of servie**
...
## 5️⃣ **Check the app's cookie policy**
...
### **File 2 → The app's privacy policy**
...
### **File 3 → The app's terms of servie**
...
### **File 4 → The app's cookie policy**

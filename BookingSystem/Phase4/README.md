...
* You now download [`docker-compose.yml`](https://github.com/vheikkiniemi/CybersecurityAndDataPrivacyAutumn2025/blob/main/BookingSystem/Phase4/docker-compose.yml) for **Phase 4** into its own folder, which will create

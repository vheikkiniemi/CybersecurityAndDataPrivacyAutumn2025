# **Quick Start Guide — Booking System Containers (Phase 2)**
...
In the folder where the **Phase 2** `docker-compose.yml` is stored:
...
* 🗄️ `cybersec-db-phase2` (PostgreSQL database)
